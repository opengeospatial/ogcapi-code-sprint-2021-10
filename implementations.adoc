...
| https://dggs-api-bozea3cspa-ew.a.run.app/dggs-api[Connexion/Flask-based prototype by the University of Tartu]
| OGC API - DGGS
...
| https://rmcf.github.io/dggs-webgis/#/[OL6/Vue.js-based DGGS web viewer by University of Tartu]
| OGC API - DGGS
